...
?>
<div class="com-content-article article--scard item-page<?php echo $this->pageclass_sfx; ?>" itemscope itemtype="https://schema.org/Article">
    ...
    <div class="page-header">
        <!-- Spostata immagine principale in questa posizione -->
    
    <!-- Inserimento linee di collegamento tra cards -->
    <div class="scard__timeline">
    ...
    <div itemprop="articleBody" class="com-content-article__body scard__body">
